...
import com.deliverytech.delivery.dtos.PedidoDTO;
...
import com.deliverytech.delivery.entities.*;
...
// CORRETO — esse deve estar na interface PedidoService
...
public class PedidoServiceImpl implements PedidoService {
    ...
    @Override
    public Page<PedidoResponseDTO> listarPedidosComPaginacao(
        StatusPedido status,
    ...
    public List<PedidoResponseDTO> buscarPedidosPorRestaurante(Long restauranteId, StatusPedido status) {
        // Implemente aqui ou retorne uma lista vazia:
        return List.of(); // só para teste
    }
