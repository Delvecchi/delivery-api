...
public class RestauranteServiceImpl implements RestauranteService {
    ...
    @Override
    public Page<RestauranteResponseDTO> buscarRestaurantesComPaginacao(String categoria, Boolean ativo, org.springframework.data.domain.Pageable pageable) {
        List<RestauranteResponseDTO> lista = new ArrayList<>();

        // lógica para popular a lista com os restaurantes filtrados

        return new PageImpl<>(lista, pageable, lista.size());
    }


    // Implementação do outro método também obrigatória
    @Override
